...
import { ongContactSchema, type OngContactFormInput } from "../model/ongForm";

/**
 * Endereço, telefones e redes da ONG. Serve o cadastro (com "Voltar") e o
 * painel (só o botão de salvar); abre com `defaultValues`, sem `reset()` tardio.
 */
export function OngContactForm({
  defaultValues,
  onSubmit,
  submitLabel,
  onBack,
